    ...
    startGallery: function(index) {
        ...
        var options = {
            ...
            onslide: function (index, slide) {
                ...
                var description = document.getElementById('blueimp-gallery').getElementsByClassName('description')[0];

                title.appendChild(document.createTextNode(this.props.pictures[index].title || ''));
                description.appendChild(document.createTextNode(this.props.pictures[index].description || ''));
                }.bind(this)
            };
